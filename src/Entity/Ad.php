...
class Ad
{
     ...
     * @Assert\Length(min=10,max=255,minMessage="Le titre doit faire + de 10 caractères",maxMessage ="Votre titre est trop long. Il ne doit pas faire + de 255 caractères")
     */
    private $title;
